...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/03/14 16:21:39 by jguigli           #+#    #+#             */
/*   Updated: 2022/03/14 16:21:41 by jguigli          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		check_y_enemy(t_data *game, char pos, int dir);
int		check_x_enemy(t_data *game, char pos, int dir);
